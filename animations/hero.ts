...
export function initHero(): void {
  ...
  if (vs) gsap.set(vs, { autoAlpha: 0, scale: 0.42, xPercent: -50, yPercent: -50 });
  ...
  if (vs) {
    tl.to(vs, { autoAlpha: 1, scale: 1, duration: 0.65, ease: "back.out(1.7)" }, 0.78);
  }
  ...
  if (vs) scrollTl.to(vs, { y: 90, autoAlpha: 0, ease: "none" }, 0);
  if (ctas.length) scrollTl.to(ctas, { y: 40, autoAlpha: 0, ease: "none" }, 0);
